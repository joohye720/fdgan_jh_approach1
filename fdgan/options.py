...
class Options():
    def __init__(self):
        ...
        #self.parser.add_argument('--dataroot', type=str, default='/home/joohye/workspace/FD-GAN-master_jh/fdgan_jh/datasets/',
         #                        help='root path to datasets (should have subfolders market1501, dukemtmc, cuhk03, etc)')
