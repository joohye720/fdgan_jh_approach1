...
def main():
    opt = Options().parse()
    dataset, train_loader, test_loader ,val_loader = get_data(opt.dataset, opt.dataroot, opt.height, opt.width, opt.batch_size, opt.workers, opt.pose_aug)
